...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div style="padding:28px 32px; overflow-y:auto;">
        ...
        <!-- ========== DIFFICULTY FILTER (auto-postback dropdown to filter cards) ========== -->
        ...
        <!-- ========== MODULE CARD GRID (3-column responsive grid of clickable cards) ========== -->
        <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:16px;">
            <asp:Repeater ID="ModulesRepeater" runat="server">
                <ItemTemplate>
                    <!-- Card link wrapper (whole card is clickable → ModuleDetail.aspx) -->
                    <a href='<%# "ModuleDetail.aspx?id=" + Eval("id") %>' class="card card-hover" style="padding:22px; display:block; text-decoration:none;">

                        <!-- Color-coded icon swatch (first letter of module title) -->
                        ...
                        <!-- Meta row (lesson count + duration) -->
                        ...
                        <!-- Progress bar with status label (Not started / In progress / Complete) -->
                        <div>
        ...
        <!-- Empty state — shown only when the filter returns zero modules -->
