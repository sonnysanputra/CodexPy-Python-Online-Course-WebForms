...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div style="padding:28px 32px; overflow-y:auto;">
        ...
        <!-- ========== PAGE HEADER (mode label "New/Edit" + quiz title heading) ========== -->
        ...
        <!-- ========== ERROR BANNER (shown if save fails or quiz not found) ========== -->
        ...
        <div class="card" style="padding:32px; max-width:640px;">
            ...
            <!-- Field: Parent module dropdown (databound; required) -->
            <div style="margin-bottom:14px;">
            ...
            <!-- Field: Description (optional, multi-line) -->
            <div style="margin-bottom:14px;">
            ...
            <!-- Field: Time limit in minutes (0–180; RangeValidator) -->
            <div style="margin-bottom:14px;">
